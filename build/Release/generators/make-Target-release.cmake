...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET make::make
                 ...
                 $<$<CONFIG:Release>:${make_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET make::make
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${make_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET make::make
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${make_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET make::make
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${make_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET make::make
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${make_COMPILE_OPTIONS_RELEASE}> APPEND)
